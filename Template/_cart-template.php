                          ...
                          <!-- product qty -->
                            <div class="qty d-flex pt-2">
                              <div class="d-flex font-rale w-25">
                                ...
                                <input type="text" data-id="pro1" class="aty_input border px-2 w-100 bg-light" disabled value="1" placeholder="1">
                          ...
                          <!-- product qty -->
                            <div class="qty d-flex pt-2">
                              <div class="d-flex font-rale w-25">
                                ...
                                <input type="text" class="aty_input border px-2 w-100 bg-light" disabled value="1" placeholder="1">
